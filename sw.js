...
self.addEventListener("fetch", e => {
  ...
  // PMTiles is fetched with HTTP Range requests. A service worker that answers those from a
  // cached whole-file response is easy to get wrong, and a malformed reply makes the map fail
  // silently. Let these go straight to the network: correct online, and offline support can be
  // added once the map is proven to work.
